...
#=============================================== tiny imagenet
# 准备数据
# 将数据resize成为299X299重新计算
train_data_path = r'E:\transfer_tiny_imagenet\data3\train_data_0.pkl'
train_label_path = r'E:\transfer_tiny_imagenet\data3\train_labels_0.pkl'
...
# 从 100000 中任选 9 张
idx = np.random.choice(2000,size=9,replace=False)
...
# 对于不同的类别，transfer 图像的分布图至少是不同的
plot_transfer_values(1000)    
...
# 不同class中间的overlap还是蛮多的
tsne = TSNE(n_components=2)
transfer_values_reduced = tsne.fit_transform(transfer_values_train) # (3000,2) 
...
#  [183, 5, 22, 55]
idx = [i for (i,t) in enumerate(cls_true) if t ==55]
...
tsne = TSNE(n_components=2)
transfer_values_2d = tsne.fit_transform(transfer_tmp) # (3000,2) 
